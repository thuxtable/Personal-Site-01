...
<body>
	...
	<div class="page" id="about" itemscope itemtype="http://schema.org/Person">
		<h1>About <span itemprop="givenName">Tyler</span> <span itemprop="familyName">Huxtable</span></h1>
		...
		<div class="pagecontent">
			<div id="aboutbanner">
				...
				<div class="halfcontent" id="aboutbrief">
					<h3>an overview</h3>
					<ul>
						<li> <span itemprop="birthPlace">Seattle</span>-born</li>
							<ul>
								<li>Rain-lover</li>
								<li>Caffeine-sipper</li>
								<li>Literary name-dropper</li>
							</ul>
						<li><span itemprop="alumniOf">UCLA</span> | Class of 2013</li>
							<ul>
								<li>English BA</li>
			...
			<div id="abouttext">
				...
				drippy forests, the San Juan Islands, fish markets, gum walls, chicken bakes, Emerald Downs, clam digs, the Muckleshoot, airplane fields, <span class="hint">red lion boats</span>, Mount Rainier, the Puyallup Fair, listening to out-of-towners pronounce "the Puyallup Fair," 
				and the <em>ad nauseum</em> fantasies of drinking-coffee-in-the-rain-while-biking-to-work-at-Microsoft-in-an-REI-coat-yada-yada.  If it weren't for my love of <span itemprop="affiliation">UCLA</span> and other such gems of the <span itemprop="homeLocation">Los Angeles</span> area, I'm afraid my heart would be forever stuck in that misty Emerald City.
				</p>
				...
				My current literary fascinations lie in contemporary Postcolonial and environmental literatures, though I've always had an inner <span class="hint">compass</span> steering me towards much more ancient Anglo-Saxon texts.
